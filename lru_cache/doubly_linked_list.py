...
class ListNode:
    ...
    def __str__(self):
        return f"{self.__class__.__name__}({self.value},{self.prev},{self.next})"
...
class DoublyLinkedList:
    ...
    def delete(self, node):
        ...
        # assuming there is actual node to be deleted
        self.length -= 1
        ...
        # if it's not the head/tail, it's a regular node
        else:
            node.delete()
